...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "ZeusBotsNetwork")
...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Zeus")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "ZeusSupport")
PROJECT_NAME = getenv("PROJECT_NAME", "Zeus Music")
OWNER = getenv("OWNER", "@Sathish2004")
